...
class CategoryService:
    ...
    def create(self, name: str, description: str = None):
        ...
        return self.repo.create(Category(name=name, description=description))
    ...
    def delete(self, category_id: int):
        ...
        if active_items:
            raise HTTPException(status_code=status.HTTP_400_BAD_REQUEST, detail="Category has active items. Archive items first.")
