...
def add_payment(
    ...
    return PaymentService(db).add_payment(bill_id, data, current_staff).to_json()
...
def get_payments(
    ...
    return PaymentService(db).get_by_bill(bill_id).to_json()
...
def remove_payment(
    ...
    return PaymentService(db).remove_payment(bill_id, payment_id, current_staff).to_json()
