import {
  Restaurant, Staff, Category, MenuItem, Table, Customer,
  Order, Bill, RfidCard, Due, Settings, SalesSummaryEntry,
  DailySale, TopItem, CaptainPerformance, RevenueLeakage, AppState
} from '../models';
...
export const BILLS: Bill[] = [
  {
    id:'BILL-2026-0181', orderId:'ORD-2026-0418', tableId:'T02', captainId:'EMP003', customerId:'CUST002',
  ...
  {
    id:'BILL-2026-0180', orderId:'ORD-2026-0417', tableId:'T09', captainId:'EMP004', customerId:'CUST007',
  ...
  {
    id:'BILL-2026-0179', orderId:'ORD-2026-0416', tableId:'T04', captainId:'EMP003', customerId:'CUST004',
...
export const RFID_CARDS: RfidCard[] = [
...
export const SALES_SUMMARY: Record<string, SalesSummaryEntry> = {
...
export const CAPTAIN_PERFORMANCE: CaptainPerformance[] = [
...
export const REVENUE_LEAKAGE: RevenueLeakage[] = [
