...
var CATEGORIES = [
  { id: "CAT001", name: "Appetizers", description: "Starters and small plates", icon: "\u{1F957}", order: 1, active: true, gstRate: 5 },
  { id: "CAT002", name: "Main Course", description: "Full meals and curries", icon: "\u{1F35B}", order: 2, active: true, gstRate: 5 },
  { id: "CAT003", name: "Breads", description: "Tandoor specialties", icon: "\u{1FAD3}", order: 3, active: true, gstRate: 5 },
  { id: "CAT004", name: "Beverages", description: "Hot and cold drinks", icon: "\u{1F964}", order: 4, active: true, gstRate: 12 },
  { id: "CAT005", name: "Desserts", description: "Sweet endings", icon: "\u{1F36E}", order: 5, active: true, gstRate: 5 },
  { id: "CAT006", name: "Soups", description: "Hearty soups and broths", icon: "\u{1F372}", order: 6, active: true, gstRate: 5 },
  { id: "CAT007", name: "Others", description: "Miscellaneous and custom items", icon: "\u{1F9FE}", order: 7, active: true, gstRate: 5 }
];
var MENU_ITEMS = [
...
var ZONES = [
  { id: "ZONE001", name: "Indoor", description: "Main air-conditioned dining area" },
  { id: "ZONE002", name: "Outdoor", description: "Open-air garden seating" },
  { id: "ZONE003", name: "Private Room", description: "Reserved private dining room" }
];
var CUSTOMERS = [
...
var BILLS = [
  {
    ...
    status: "Paid",
    createdAt: "2026-04-17T13:50:00"
  },
  {
    id: "BILL-2026-0180",
    orderId: "ORD-2026-0417",
    tableId: "T09",
    captainId: "EMP004",
    customerId: "CUST007",
    subtotal: 3380,
    ...
    totalTax: 159,
    total: 3339,
    payments: [{ method: "RFID", amount: 2e3 }, { method: "Online", amount: 1339 }],
    status: "Paid",
  ...
  },
  {
    ...
    totalTax: 77,
    total: 1617,
    payments: [{ method: "Cash", amount: 617 }, { method: "Online", amount: 1e3 }],
    status: "Paid",
    createdAt: "2026-04-16T20:30:00"
  }
];
var RFID_CARDS = [
  { id: "RFID-001", cardNo: "4A:2B:9C:7D", customerId: "CUST001", balance: 1850, status: "Active", loadHistory: [{ amount: 2e3, mode: "Cash", date: "2026-04-10", balance: 2e3 }, { amount: 150, mode: "Deduction", date: "2026-04-15", balance: 1850 }] },
  ...
  { id: "RFID-004", cardNo: "6E:1A:3C:9B", customerId: "CUST004", balance: 5e3, status: "Active", loadHistory: [{ amount: 5e3, mode: "Online", date: "2026-04-12", balance: 5e3 }] },
...
function getInitialAppState() {
  return {
    ...
    menuItems: JSON.parse(JSON.stringify(MENU_ITEMS)),
    categories: JSON.parse(JSON.stringify(CATEGORIES)),
    staff: JSON.parse(JSON.stringify(STAFF)),
    rfidCards: JSON.parse(JSON.stringify(RFID_CARDS)),
    dues: JSON.parse(JSON.stringify(DUES)),
...
//# sourceMappingURL=chunk-YRUH6UFD.js.map
